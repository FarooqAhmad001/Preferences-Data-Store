...
class PreferenceDataStoreHelper(context: Context): IPreferenceDataStoreAPI {
    ...
    */
    override suspend fun <T> getPreference(key: Preferences.Key<T>, defaultValue: T): T = dataSource.data.first()[key] ?: defaultValue
    ...
    */
    override suspend fun <T> getFlowPreference(key: Preferences.Key<T>, defaultValue: T): Flow<T> = dataSource.data.catch { exception ->
